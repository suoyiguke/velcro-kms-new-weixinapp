...
Page({
  ...
  onLoad: function (options) {
    var that = this ;
    wx.request({
      url: app.globalData.urlPrefix + "mobile/execute.do?action=getWikiList&creator=&currentPage=1&key=myTask&model=knowledge&objname=&pageSize=20&type=myTask&userId=402881e70be6d209010be75668750014",
      data: {
        x: '',
        y: ''
      },
